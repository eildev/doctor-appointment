    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('faq.store') }}" id="myForm" method="POST">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 form-group">
                                    <input class="form-control" type="text" placeholder="Enter Question"
                                        id="example-text-input" name="question">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 form-group">
                                        <textarea class="form-control" id="summernote"  name="answer" placeholder="Please provide Answer" cols="30" rows="5"></textarea>
                                </div>
                            </div>
