...
<div class="row">
            <div class="col-12">
              ...
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               <h4>Add Consulting Center</h4><br>
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                ...
                <hr>
                <form action="{{route('store.consulting.center')}}" id="myForm" method="post"   >
                    @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control "  name="name" type="text" placeholder="Enter  name" id="institution_namet">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control"  name="contact_email" type="email" placeholder="Enter Email Address" id="institution_name3">
                    </div>
                </div>
                <div class="row mb-3">
                    <label for="institution_namet4" class="col-sm-2 col-form-label">Contact Number</label>
                    <div class="col-sm-10 form-group">
                        <input class="form-control "  name="contact_number" type="text" placeholder="Enter Contact Number" id="institution_name4">
                    </div>
                </div>
