        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Add Social Link</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Social</a></li>
                            <li class="breadcrumb-item active">Add Social Media account</li>
                        </ol>
                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 form-group">
                                    <input class="form-control" type="url" placeholder="Please provide facebook link"
                                        id="example-search-input" name="facebook">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 form-group">
                                    <input class="form-control" type="url" placeholder="Please provide instragram link"
                                        id="example-search-input" name="instragram">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 form-group">
                                    <input class="form-control" type="url" placeholder="Please provide Twitter link"
                                        id="example-search-input" name="twitter">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="example-search-input" class="col-sm-2 col-form-label">linkdin</label>
                                <div class="col-sm-10 form-group">
                                    <input class="form-control" type="url" placeholder="Please provide linkdin link"
