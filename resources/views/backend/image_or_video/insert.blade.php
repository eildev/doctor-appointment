...
<div class="row">
            ...
            <div class="page-title-right">
               <ol class="breadcrumb m-0">
                ...
                <hr>
                <form action="{{route('store.image.video')}}" id="myForm" method="post" enctype="multipart/form-data"  >
                    @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control" name="section_name" type="text" placeholder="Enter Section name" id="institution_namet">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control"   name="media_url" type="url" placeholder="Enter Video Url" id="institution_namet2">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                            {{-- <img id="showImage" class="rounded avatar-lg"
                                src="{{ asset('uploads/no_image/images.png') }}" width="100px" height="100px" alt="Media  type Image/Video"> --}}
