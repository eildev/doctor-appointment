               ...
               <ol class="breadcrumb m-0">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control" name="short_caption" type="text" value="{{$sliders->short_caption}}" placeholder="Enter Short Caption" id="example-email-input">
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <textarea class="form-control"  type="text"  placeholder="Enter Long Caption"  name="long_caption" cols="30" rows="5">{{$sliders->long_caption}}</textarea>
                    </div>
