                                    ...
                                    @foreach ($blogPost as $blog)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('blog.post.edit',$blog->id)}}"class="btn btn-info btn-sm" title="Edit Data">Edit</a>
                                                <a href="{{route('blog.post.delete',$blog->id)}}" class="btn btn-danger btn-sm" title="Delete Data" id="delete">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
