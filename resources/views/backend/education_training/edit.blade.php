...
<div class="row">
            <div class="col-12">
              ...
              <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               <h4>Edit Education And Training</h4><br>
               ...
               <ol class="breadcrumb m-0">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control  @error('institution_name') is-invalid  @enderror" name="institution_name" value="{{$eduTrain->institution_name}}" type="text" placeholder="Enter your institution name" id="institution_namet">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10 form-group">
                        <input class="form-control @error('degree') is-invalid  @enderror" type="text" name="degree" value="{{$eduTrain->degree}}" placeholder="Degree" id="example-input">
                        @error('degree')
                        <span id="name_error" class="text-danger">{{ $message }}</span>
                         @enderror
                    </div>
