        ...
        <p class="msg-info">Your new product has approved</p>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{(!empty(Auth::user()->photo)) ?url('admin_image/profile/'.Auth::user()->photo): url('admin_image/profile/no_images.png')}}" class="user-img" alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{route('change.password')}}"><i class='bx bx-home-circle'></i><span>Change Password</span></a>
                    </li>
